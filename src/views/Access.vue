<template>
    <div class="container">
        <el-input placeholder="请输入内容" v-model="input1" class="input-with-select"></el-input>
        ...
        <el-table :data="searchData" style="width: 100%" max-height="250" class="ttt">
            ...
            <el-table-column prop="age" label="工作年限" width="120"></el-table-column>
            <el-table-column prop="province" label="省区" width="120"></el-table-column>
            ...
            <el-table-column fixed="right" label="操作" width="120">
                <template slot-scope="scope">
                    <el-button
                        type="text"
                        size="small"
                        @click="clearuser(scope.row.name,scope.$index,searchData)"
                    >删除管理员</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods: {
        ...
        clearuser(user, index, rows) {
            ...
            if (con == true) {
                ...
                rows.splice(index, 1);
                axios
                    .get("/user/clearuser", { params: { name: user } })
                    .then(res => {
