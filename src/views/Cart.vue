              ...
              <li v-for="(item,index) in cardList" :key="index">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a class="checkbox-btn item-check-btn" v-bind:class="{'check':parseInt(item.checked)}" @click="checkProduct(item,index)">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="subt(index)">-</a>
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn">
                      <svg class="icon icon-del" @click="deleteProduct(index)">
          ...
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">{{priceCount}}</span>
              </div>
              <div class="btn-wrap">
...
<script>
  ...
  import axios from 'axios'
    ...
    export default{
        ...
        methods:{
          getCardList(){
            axios.get('/goods/cardList').then((response)=>{
              let res=response.data;
              if(res.status=='0'){
                this.cardList=res.result.theCardList;
          ...
          deleteProduct(index){
            ...
            if(mymessage==true){
            // alert(index);
              axios.post('/goods/deleteProduct',{
                productIndex:index
              }).then((response)=>{
                let res=response.data;
                if(res.status=='0'){
