<template>
    <div>
      <header class="header">
        ...
        <div class="navbar">
          ...
          <div class="navbar-right-container" style="display: flex;">
            <div class="navbar-menu-container">
              ...
              <!--loginIf为true时，是登陆状态-->
              <a href="javascript:void(0)" class="navbar-link" v-if="!loginIf" @click="goLogin()">Login</a>
              <a href="javascript:void(0)" class="navbar-link" v-else @click="goLogout()">Logout</a>
        ...
        <!--dlkFlag为true时，登陆框出现，遮罩出现-->
        <!--点击close后，登陆框消失，遮罩消失-->
        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':dlkFlag}">
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">Login in</div>
              <button class="md-close" @click="dlkFlag=false;">Close</button>
            </div>
        ...
        <div v-bind:class="{'md-overlay':dlkFlag}" ></div>
      </header>
    </div>
</template>
...
export default {
  ...
  methods:{
    ...
    goLogout(){
      axios.get('/goods/logout').then((response)=>{
